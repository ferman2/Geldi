...
cl = CYBERTK.LINE()
cl.login(token="EqDO0tzJVk0JJo93Mrfd.oQZ09gmUFH5+psITId2t7q.mIvEFBBkfI3rB0v0c3k2YMQeuXG+2DwvNnyJCG65BUI=")
cl.loginResult()
...
helpMessage ="""
║════════════════
║[̲̅F̲̅][̲̅E̲̅][̲̅R̲̅][̲̅M̲̅][̲̅A̲̅][̲̅N̲̅][̲̅N̲̅] [̲̅M̲̅][̲̅e̲̅][̲̅n̲̅][̲̅ü̲̅]
║
...
║
║[̲̅F̲̅][̲̅e̲̅][̲̅R̲̅][̲̅M̲̅][̲̅A̲̅][̲̅N̲̅][̲̅l̲̅] [̲̅s̲̅][̲̅e̲̅][̲̅t̲̅][̲̅t̲̅][̲̅i̲̅][̲̅n̲̅][̲̅g̲̅]
║               〘/Protect〙
║              〘/Steal〙  
║             〘ᎪᏞᏞ ᎷᏆᎠ〙
║               〘/Gift〙
...
admin=["u3aacf4f4632e7e1e7f3d28ad883d93ed"]
creator=["u3aacf4f4632e7e1e7f3d28ad883d93ed"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"TEŞEKKÜRLER EKLEDİGİNİZ İÇİN ☆ TR ☆\n\n\Support By ~ ҳ̸Ҳ̸ҳ djfermanofficial ҳ̸Ҳ̸ҳ\n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~djfermanofficial",
    "lang":"JP",
    "comment":"TEŞEKKÜRLER EKLEDİGİNİZ İÇİN ☆ TR ☆\n\n\Support By ~ ҳ̸Ҳ̸ҳ djfermanofficial ҳ̸Ҳ̸ҳ\n\n✯==== Creator ====✯\n\nhttp://line.me/ti/p/~djfermanofficial",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#------------------NOTIFIED_READ_MESSAGE----------------#
        ...
        if op.type == 17:
           if wait["Wc"] == False:
               ...
               random.choice(KAC).sendText(op.param1, "Hoşgeldiniz" + str(ginfo.name))
               random.choice(KAC).sendText(op.param1, "Pembuat Grup : " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
               random.choice(KAC).sendText(op.param1,"FERMAN !!")
               print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
            if wait["Lv"] == False:
                if op.param2 in Bots:
                    return
                ki.sendText(op.param1, "Gule Gule")
                print "MemberLeft"
#-----------------------------------------------
        if op.type == 11:
            if op.param3 == '1':
